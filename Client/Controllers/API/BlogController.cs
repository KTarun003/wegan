...
namespace Client.Controllers.API
{
    ...
    public class BlogController : ControllerBase
    {
        ...
        public BlogController(AppIdentityDbContext context,UserManager<IdentityUser> userManager)
        {
            _context = context;
        ...
        public async Task<ActionResult<IEnumerable<Post>>> GetPosts()
        {
            ...
            foreach (Post item in (await _context.Posts.ToListAsync()).Where(item => item.Type.Equals(PostType.Blog.ToString()) && item.IsApproved))
            {
                posts.Add(item);
            }
